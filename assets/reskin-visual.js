...
(() => {
 ...
 const name=byId("person-name"),welcome=byId("welcome"),avatar=byId("avatar-top");
 ...
 function avatarFallback(){
   ...
   const empty=!src||src.includes("assets/favicon.svg")||avatar.dataset.visualError==="true";
 ...
 avatar?.addEventListener("error",()=>{
   avatar.dataset.visualError="true";avatarFallback();
 });
 ...
 document.addEventListener("proxiti-session-ready",()=>{
   ...
   greeting();avatarFallback();requestAnimationFrame(syncSidebar);
 });
